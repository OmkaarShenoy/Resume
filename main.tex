...
New American University Scholar, \href{https://engineering.asu.edu/tempe-fulton-ambassadors/}{Fulton Ambassador} \faExternalLink, \href{https://gcsp.engineering.asu.edu/}{Grand Challenge Scholars Program} \faExternalLink \\
...
\textbf{Languages and Frameworks}: Java, HTML5, CSS3, Javascript,Typescript, React, Redux, Bootstrap, MySQL \\
...
\begin{itemize}
    ...
    \item Integrating AWS with the webapp for users to be able to sign in and interact with external hardware. Used PHP and MySQL to create the database. 
