\documentclass[10pt]{article}
  \usepackage{geometry}
  \linespread{1}
  \geometry{paperwidth=8in, paperheight=11in, margin=0.75in} % Custom wider paper size
  \usepackage{amsmath}
  \usepackage{amssymb}
  \usepackage{textcomp}
...
\textbf{Junior Data Engineer}, \textit{Aramark} \hfill Philadelphia, PA | May 2025 – Present\\
\vspace{-1mm}
\begin{itemize}[leftmargin=5mm, itemsep=0mm]
  \item Designed and maintained scalable data pipelines and models across multiple enterprise systems, supporting reconciliation and analytics for thousands of retail locations and processing millions of transactions monthly.
  \item Implemented logic to normalize, validate, and reconcile high-volume financial and operational datasets using \textbf{SQL} and \textbf{Python}, enhancing data quality and improving traceability across key systems.
  \item Developed real-time alerting and anomaly detection frameworks for fraud and hardware monitoring, reducing investigation cycles and driving process improvements adopted across multiple business units.
\end{itemize}
...
\begin{itemize}[leftmargin=5mm, itemsep=0mm]
 ...
 % \item \textbf{Led} agile development initiatives by spearheading sprint planning sessions in Azure DevOps contributing to enhanced team productivity and agile practices.  % \item \textbf{Led} agile development initiatives by spearheading sprint planning sessions in Azure DevOps contributing to enhanced team productivity and agile practices.
\end{itemize}
...
\begin{itemize}[leftmargin=5mm, itemsep=0mm]
  ...
  \item Collaborated in an agile environment using \textbf{Git}, \textbf{Jira}, \textbf{Docker}, and \textbf{Kubernetes} to ship production-ready code across QA environments.
\end{itemize}
...
\vspace{1mm}
  • Led end-to-end development of a \textbf{universal medical record database} with \textbf{React, Express.js, and MongoDB}, providing secure, scalable, and responsive solutions for enhancing \textbf{patient-physician collaboration} through efficient data accessibility.

  \vspace{2mm}
\textbf{Other Projects:} Built \textbf{SuperTutor}, an accessible LaTeX-based course tool with OpenAI integration (\textit{HackSoDa Winner}); contributed to \textbf{HackKit}, an open source points system used by national hackathons.
